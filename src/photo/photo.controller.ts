import { Controller, Post, UseInterceptors, UploadedFile, ParseIntPipe, Param, Delete } from '@nestjs/common';
...
export class PhotoController {
    ...
    async uploadPhoto(
        ...
        return { 'photo': this.configService.get<string>('PHOTOS_BASE_URL') + productId + '/' + file.filename }
    }
    @Delete(':id')
